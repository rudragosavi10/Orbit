export function GoogleIcon() {
  return (
    ...
    >
      ...
      <path
        fill="#4CAF50"
        d="M24 44c5.2 0 10-2 13.4-5.2l-6.2-5.2C29.2 35.1 26.8 36 24 36c-5.2 0-9.6-3.3-11.2-8l-6.5 5C9.5 39.6 16.2 44 24 44z"
      />
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3c-1.1 3.2-3.4 5.6-6.6 7.1l6.2 5.2C38.5 37 44 31.2 44 24c0-1.3-.1-2.3-.4-3.5z"
      />
    </svg>
  );
}