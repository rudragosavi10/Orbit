      ...
      <div className="flex h-full items-center justify-between px-5 md:px-8">
        <div className="flex h-full items-center">
          <button
            ...
            className="mr-4 inline-flex h-11 w-11 items-center justify-center rounded-xl text-slate-700 transition-colors hover:bg-slate-200 hover:text-slate-950 md:hidden"
          >
